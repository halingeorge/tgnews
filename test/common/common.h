...
struct TestDocument {
  TestDocument(std::string name, std::string content, std::chrono::seconds max_age)
...
TestDocument GenerateDocument(std::mt19937& mt, std::chrono::seconds max_age = 1024s);

std::vector<TestDocument> GenerateDocuments(std::mt19937& mt, size_t count, std::chrono::seconds max_age = 1024s);
